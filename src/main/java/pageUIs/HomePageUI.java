...
public class HomePageUI {
    ...
    public static final String OWN_COMPUTER_PRODUCT_LINK = "xpath=//a[text()='Build your own computer']";
    public static final String COMPUTERS_LINK = "xpath=//ul[@class='top-menu notmobile']/li/a[text()='Computers ']";
